          ...
          <div className="min-w-0 flex-1 flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-6">
            <div>
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="text-xs font-bold px-2.5 py-0.5 rounded-lg bg-sky-100 text-sky-800 border border-sky-200 flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-2 gap-4 text-xs">
                  <div>
                    ...
                    <p className="font-extrabold text-sky-800 mt-0.5 flex items-center gap-1.5">
                      ...
                      <span className="font-black text-slate-900">{bill.current_holder_name}</span>
                    </p>
                  </div>
                  <div>
